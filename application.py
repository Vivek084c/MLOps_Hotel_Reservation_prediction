...
def index():
    if request.method=="POST":
        ...
        features = np.array([[lead_time, no_of_special_request, avg_price_per_room, arival_month, arival_date, market_segment_type, no_of_week_nights, no_of_weekend_nights, type_of_meal_plan, room_type_reserved]])
